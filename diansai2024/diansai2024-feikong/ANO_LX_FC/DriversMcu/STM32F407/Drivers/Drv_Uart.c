...
#define U1GetOneByte	NoUse  //空置Lanya_Receive_Data
//#define U1GetOneByte	Lanya_Receive_Data
#define U2GetOneByte	T265_data                       //树莓派串口
#define U3GetOneByte 	Lanya_Receive_Data
//#define U3GetOneByte	Lanya_Receive_Data                         //openmv串口
...
void DrvUart1Init(u32 br_num)
{
    ...
    USART_InitStructure.USART_BaudRate = br_num;   		//波特率可以通过地面站配置
		uk=USART_InitStructure.USART_BaudRate;
